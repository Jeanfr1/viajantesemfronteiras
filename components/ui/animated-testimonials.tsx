...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    handleNext(); // Ensure handleNext is included in the dependency array
    if (autoplay) {
  ...
  const getRotation = (index: number) => {
    // Use a deterministic rotation based on index
    return ((index % 3) - 1) * 5; // Will return -5, 0, or 5 degrees
  };
